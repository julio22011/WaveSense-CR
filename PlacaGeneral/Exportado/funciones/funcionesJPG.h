// Funciones para mostrar JPG, necesita de la libreria <JPEGDecoder.h>
...
void jpegRender(int xpos, int ypos) {
  ...
  tiempoDeTrazadoIMG = millis() - drawTime;
  showTime(tiempoDeTrazadoIMG); // These lines are for sketch testing only
}
