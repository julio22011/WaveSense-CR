...
void iniciarBotones(int stack) {    //  stack> 1000
  BaseType_t tar13 = xTaskCreatePinnedToCore(
    ...
    "Botones",    // Name of the task (for debugging) // 5000 ok
    stack,               // Stack size (bytes)
    NULL,               // Parameter to pass
    2,                  // Task priority
    NULL,               // Task handle
...
//====================================================================
// Provicional, no se sabe si se va a utilizar
#include "archivoTarea/archivoTareaActualizarDatos.h"
void iniciarActualizarDatos(int stack) {    //  stack> 1000
  BaseType_t tar14 = xTaskCreatePinnedToCore(
    tareaActualizarDatos,      // Function that should be called
    "ActualizarDatos",    // Name of the task (for debugging) // 5000 ok
    stack,               // Stack size (bytes)
    NULL,               // Parameter to pass
    3,                  // Task priority
    NULL,               // Task handle
