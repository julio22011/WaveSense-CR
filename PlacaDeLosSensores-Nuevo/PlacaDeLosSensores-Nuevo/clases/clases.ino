...
//////////////////////////////
// Lo siguiente es una prueba de la clase de filtros
...
void funcionPruebaDeSensores(){
  ...
  // Inciar los sensores:
  todosLosSensores[0].inicializar(sensorTemp, pin_Temp, false);                    // false, no utiliza ADC
  todosLosSensores[1].inicializar(sensorPH, pinADC_pH, true, &ads1);
  todosLosSensores[2].inicializar(sensorConductividad, pinADC_Cond, true, &ads1);
  todosLosSensores[3].inicializar(sensorTurbidez, pinADC_Turb, true, &ads1);
  todosLosSensores[4].inicializar(sensorTDS, pinADC_Cond, true, &ads1);                           // usa el mismo sensor de conductividad
}
